...
def plot_detector_data(det, strain_L1_whitenbp, strain_H1_whitenbp, template_match, time, timemax, SNR, tevent, eventname, plottype, freqs, datafreq, template_fft, data_psd, fs, d_eff):
